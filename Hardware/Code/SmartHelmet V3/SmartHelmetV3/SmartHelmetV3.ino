...
void drawArrow(String symbol) {
  ...
  if (symbol == "L") {
    display.fillTriangle(5, 25, 20, 15, 20, 35, SSD1306_WHITE);
    display.fillRect(20, 22, 15, 6, SSD1306_WHITE);
  }
  else if (symbol == "R") {
    display.fillTriangle(35, 25, 20, 15, 20, 35, SSD1306_WHITE);
    display.fillRect(5, 22, 15, 6, SSD1306_WHITE);
  }
  else if (symbol == "S") {
    display.fillTriangle(20, 10, 10, 25, 30, 25, SSD1306_WHITE);
    display.fillRect(17, 25, 6, 15, SSD1306_WHITE);
  }
  else if (symbol == "U") {
    display.drawCircle(20, 20, 10, SSD1306_WHITE);
    display.fillTriangle(15, 30, 10, 35, 20, 35, SSD1306_WHITE);
  }
  else if (symbol.startsWith("RA")) {
    display.drawCircle(20, 25, 15, SSD1306_WHITE);
    display.setTextSize(2);
...
String getDirectionText(String symbol) {
  ...
  if (symbol == "S") return "Go STRAIGHT";
  if (symbol == "U") return "U-TURN";
